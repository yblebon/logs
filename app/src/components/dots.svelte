...
<div
  class="accordion border-light bg-light mx-auto mt-4"
  ...
  {#each dots.dots as dotsElement, index}
    <div class="accordion-item">
      <h2 class="accordion-header">
        <button
          class="accordion-button text-capitalize fw-light fs-6"
          type="button"
          data-bs-toggle="collapse"
    ...
    >
      <div class="accordion-body">
        {#if dotsElement.video == "filebase"}
          <video
            class="card-img-top rounded-0 video-js"
            controls
            width="100%"
            height="300"
            preload="auto"
            poster="fafo/IMG_0461.png"
          >
        ...
        {:else}
          <img
            src="{filebaseBase}/{dotsElement.src}"
            class="card-img-top rounded-0"
          />
        {/if}
      </div>
